...
_TRAIN_DOWNLOAD_URL = "data/trecis/train.json"
_VAL_DOWNLOAD_URL = "data/trecis/val.json"
_TEST_DOWNLOAD_URL="data/trecis/test.json"

class TRECIS(datasets.GeneratorBasedBuilder):
    """customize dataset."""
